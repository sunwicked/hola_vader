...
package app.com.application.fetch;
...
import app.com.application.fetch.callback.FetchCall;
import app.com.application.fetch.callback.FetchTask;
import app.com.application.fetch.exception.EnqueueException;
import app.com.application.fetch.listener.FetchListener;
import app.com.application.fetch.request.Request;
import app.com.application.fetch.request.RequestInfo;
...
public final class Fetch implements FetchConst {
     ...
     * <p>
     * <p>Method calls on this Fetch instance will throw a    ,
     ...
     * @throws       if the release method has been called on Fetch.
     */
     ...
     * @return a List of RequestInfo object that contains the status and progress of a request.
     * If no requests are found, an empty list will be returned.
     * @throws  if the passed in status is not a valid status.
     * @throws         if the release method has been called on Fetch.
     */
    @NonNull
